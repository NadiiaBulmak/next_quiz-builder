...
export default function AuthFormSection({heading, subheading, children}: AuthFormSectionProps) {
    return (
        <div className="flex w-full md:w-[60%] rounded-xl flex-col items-center justify-center md:items-start bg-white px-6 py-8 shadow-md border-0.5 border-gray-300">
