...
export const CopyPreviewLinkButton = ({ id }: CopyPreviewLinkButtonProps) => {
  ...
  return (
    <Button
      className="rounded-md border border-black bg-black px-3 py-2 font-semibold text-white cursor-pointer transition-all duration-150 hover:bg-black hover:border-lime-500 hover:shadow-[0_0_0_2px_rgba(132,204,22,0.25)] h-full"
