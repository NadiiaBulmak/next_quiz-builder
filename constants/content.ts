...
export const CONTENT = {
  ...
  metadata: {
    root: {
      title: 'Quiz Flow | Create, Share & Analyze Quizzes',
      description:
        'Create interactive quizzes, share them with your audience, and analyze results with Quiz Flow.',
    },

    auth: {
      login: {
        title: 'Quiz Flow | Log In',
        description:
          'Log in to your Quiz Flow account to create, manage, and analyze your quizzes.',
      },
      signUp: {
        title: 'Quiz Flow | Sign Up',
        description:
          'Create your Quiz Flow account and start creating interactive quizzes in minutes.',
      },
      forgotPassword: {
        title: 'Quiz Flow | Forgot Password',
        description:
          'Reset your Quiz Flow password and regain access to your account.',
      },
      forgotPasswordSent: {
        title: 'Quiz Flow | Check Your Email',
        description:
          'Check your email for instructions to reset your Quiz Flow password.',
      },
      resetPassword: {
        title: 'Quiz Flow | Reset Password',
        description: 'Create a new password for your Quiz Flow account.',
      },
    },

    quizzes: {
      all: {
        title: 'Quiz Flow | All Quizzes',
        description: 'Browse and explore all available quizzes in Quiz Flow.',
      },
      my: {
        title: 'Quiz Flow | My Quizzes',
        description:
          'Manage and organize the quizzes you have created in Quiz Flow.',
      },
      create: {
        title: 'Quiz Flow | Create Quiz',
        description:
          'Create a custom interactive quiz with questions, answers, and difficulty levels.',
      },
      results: {
        title: 'Quiz Flow | Quiz Results',
        description:
          'View quiz performance, participant responses, and detailed results.',
      },
      resultDetails: {
        title: 'Quiz Flow | Quiz Results',
        description:
          'Analyze detailed participant performance and quiz statistics.',
      },
    },

    quiz: {
      preview: {
        title: 'Quiz Flow | Quiz Preview',
        description: 'Preview your quiz before sharing it with participants.',
      },
      edit: {
        title: 'Quiz Flow | Edit Quiz',
        description:
          'Edit questions, answers, settings, and other details of your quiz.',
      },
      take: {
        title: 'Quiz Flow | Take Quiz',
        description: 'Complete this interactive quiz and test your knowledge.',
      },
      result: {
        title: 'Quiz Flow | Quiz Result',
        description: 'View your quiz performance and review your results.',
      },
    },

    settings: {
      title: 'Quiz Flow | Settings',
      description:
        'Manage your Quiz Flow account, profile, and application settings.',
    },

    legal: {
      privacy: {
        title: 'Quiz Flow | Privacy Policy',
        description:
          'Read the Quiz Flow Privacy Policy to learn how your information is collected and used.',
      },
      terms: {
        title: 'Quiz Flow | Terms of Service',
        description:
          'Read the Quiz Flow Terms of Service and learn about the rules for using the platform.',
      },
    },

    createPreview: {
      title: 'Quiz Flow | Create Preview',
      description: 'Preview the quiz creation experience in Quiz Flow.',
    },
  },
  auth: {
    login: {
